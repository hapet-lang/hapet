...
dotnet publish ../HapetUpdater/HapetUpdater.csproj --configuration Release --runtime win-x64 -f net8.0
...
Copy-Item -Path "../HapetUpdater/bin/Release/net8.0/win-x64/publish/*" -Destination "./staging_folder/" -Recurse -Force
