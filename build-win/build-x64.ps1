...
Copy-Item -Path "../xwin-tool/.xwin-cache/splat/crt/lib/x86_64/msvcrt.lib" -Destination "$libsDest/" -Force
Copy-Item -Path "../xwin-tool/.xwin-cache/splat/sdk/lib/ucrt/x86_64/ucrt.lib" -Destination "$libsDest/" -Force
