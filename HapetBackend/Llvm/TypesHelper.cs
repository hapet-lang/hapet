        ...
        private unsafe LLVMValueRef CreateCast(LLVMBuilderRef builder, LLVMValueRef val, HapetType inType, HapetType outType)
        {
            ...
            if (inType is NullType)
            {
                ...
                if (outType is ArrayType arrayType)
                {
                    ...
                    var buffer = _builder.BuildStructGEP2(HapetTypeToLLVMType(arrayType), v, 1, "arrBuffer");
                ...
                else if (outType is StringType stringType)
                {
                    ...
                    var buffer = _builder.BuildStructGEP2(HapetTypeToLLVMType(stringType), v, 1, "strBuffer");
                    _builder.BuildStore(nullTarget, buffer);
