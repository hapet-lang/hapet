        ...
        internal AstStatement ParseStatement(ParserInInfo inInfo, ref ParserOutInfo outInfo, bool parseAtomic = false)
        {
            ...
            switch (token.Type)
            {
                ...
                case TokenType.KwTry:
                    toReturn = ParseTryCatchStatement(inInfo, ref outInfo);
                    break;

                case TokenType.KwGoto:
                    toReturn = ParseGotoStatement(inInfo, ref outInfo);
                    break;
                ...
                default:
                    {
                        ...
                        else if (stmt is AstNestedExpr nestExpr2 && nestExpr2.RightPart is AstTupleExpr tpl)
                        {
                            stmt = PrepareTupleExpr(nestExpr2, tpl, inInfo, ref outInfo);
                        }
