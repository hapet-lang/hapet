...
namespace Frontend.Parsing.Entities
{
	public struct NumberData : IEquatable<NumberData>
	{
		...
		public int Size { get; private set; } // bytes to use to alloc the number
		public bool IsSigned { get; private set; } // is signed int
		...
		public NumberData(NumberType type, string val, int b)
		{
			...
			// TODO: should be calculated properly
			Size = 4;
			IsSigned = true;
		}
		...
		[Obsolete("Should dynamic type be used")]
		...
		[Obsolete("Not obsolete but should be used accurately")]
		public static NumberData FromBigInt(BigInteger num)
		{
			return new NumberData
			{
				Size = num.GetByteCount(),
				IsSigned = num.Sign < 0,
				IntBase = 10,
		...
		public static NumberData FromLongInt(long num)
		{
			return new NumberData
			{
				Size = 8,
		...
		public static NumberData FromIntInt(int num)
		{
			return new NumberData
			{
				Size = 4,
		...
		public static NumberData FromDouble(double num)
		{
			...
			{
				Size = 8,
				IsSigned = true, // not used for floating
				IntBase = 10,
				StringValue = num.ToString(CultureInfo.InvariantCulture),
		...
		public static NumberData FromFloat(float num)
		{
			return new NumberData
			{
				Size = 4,
